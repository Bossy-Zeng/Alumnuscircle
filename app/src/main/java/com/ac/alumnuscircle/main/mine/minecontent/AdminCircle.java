...
public class AdminCircle extends Fragment {
   ...
   private static int SUCCESS = 0X100;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.minecontent_admincirclefgt, container, false);
    ...
    private void initRecycleView() {
        ...
        rvAdminCircle.setAdapter(adapter);

        rvAdminCircle.addItemDecoration(new DividerLinearItemDecoration(getActivity(),
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                RequestBody myCircleBody = new FormBody.Builder().add("_xsrf", HttpGet.loginKey)
                        .add("my_filter_circle", MyInfo.myInfo.getAdmin_circle_list())
                        .build();

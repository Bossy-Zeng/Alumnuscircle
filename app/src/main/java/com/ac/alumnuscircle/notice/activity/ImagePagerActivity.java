...
public class ImagePagerActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notice_imagepageract);
        ViewPager viewPager = (ViewPager) findViewById(R.id.notice_imagepageract_pager);
        guideGroup = (LinearLayout) findViewById(R.id.notice_imagepageract_guideGroup);
    ...
    private static class ImageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            View view = inflater.inflate(R.layout.notice_item_pager_image, container, false);
            if(view != null){
                final ImageView imageView = (ImageView) view.findViewById(R.id.notice_item_pager_image);

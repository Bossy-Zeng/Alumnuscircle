...
public class DatasUtil {
	...
	public static final String[] PHOTOS = {
			...
			"http://img5.imgtn.bdimg.com/it/u=3445497520,1801625963&fm=21&gp=0.jpg",
	...
	static {
		User user1 = new User("1", "灰熊", HEADIMG[1]);
		User user2 = new User("2", "凡鸽", HEADIMG[2]);
		User user3 = new User("3", "隔壁老曾", HEADIMG[3]);
		User user4 = new User("4", "master", HEADIMG[4]);
		User user5 = new User("5", "龙wifi", HEADIMG[5]);
		User user6 = new User("6", "高冷的master", HEADIMG[6]);
...
//			}
    ...
    public static List<String > createOnePhoto()
	{
		List<String> photo = new ArrayList<>();
		String onepto=PHOTOS[getRandomNum(PHOTOS.length)];
		photo.add(onepto);
		return photo;
	}

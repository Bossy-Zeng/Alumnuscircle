            ...
            case MotionEvent.ACTION_MOVE:
                if (mStatus == STATUS_MULTI_TOUCHING) {
                    ...
                    if (!(dx == 0 && dy == 0)) {
                        switch (currentEdge) {
                            case EDGE_LT:
                                int lt_abs_dx = Math.abs(dx);
                                int lt_abs_dy = Math.abs(dy);
                                scale = dy;
                                if (lt_abs_dx > lt_abs_dy) {
                                    scale = dx;
                                }
                                mDrawableFloat.set(mDrawableFloat.left + scale,
                                        mDrawableFloat.top + scale,
                                        mDrawableFloat.right,
                                        mDrawableFloat.bottom);
                                break;
                            case EDGE_RT:
                                int rt_abs_dx = Math.abs(dx);
                                int rt_abs_dy = Math.abs(dy);
                                scale = dy;
                                if (rt_abs_dx > rt_abs_dy) {
                                    scale = dx;
                                    mDrawableFloat.set(mDrawableFloat.left,
                                            mDrawableFloat.top - scale,
                                            mDrawableFloat.right + scale,
                                            mDrawableFloat.bottom);
                                    break;
                                }else {
                                    scale = dy;
                            ...
                            case EDGE_LB:
                                int lb_abs_dx = Math.abs(dx);
                                int lb_abs_dy = Math.abs(dy);
                                scale = dy;
                                if (lb_abs_dx > lb_abs_dy) {
                                    scale = dx;
                                    mDrawableFloat.set(mDrawableFloat.left + scale,
                                            mDrawableFloat.top,
                                            mDrawableFloat.right,
                                            mDrawableFloat.bottom - scale);
                                    break;
                                }else {
                                    scale = dy;
                                    mDrawableFloat.set(mDrawableFloat.left - scale,
                            ...
                            case EDGE_RB:
                                int rb_abs_dx = Math.abs(dx);
                                int rb_abs_dy = Math.abs(dy);
                                scale = dy;
                                if (rb_abs_dx > rb_abs_dy) {
                                    scale = dx;
                                }
                                mDrawableFloat.set(mDrawableFloat.left,
                                        mDrawableFloat.top,

package com.ac.alumnuscircle.notice.widgets;
...
import com.ac.alumnuscircle.notice.spannable.CircleMovementMethod;
import com.ac.alumnuscircle.notice.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        View convertView = layoutInflater.inflate(R.layout.notice_item_comment, null, false);

        TextView commentTv = (TextView) convertView.findViewById(R.id.notice_item_commentTv);
